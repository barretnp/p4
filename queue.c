...
//
// Based on the Code130_Queue implementation
// 
...
char Dequeue()
{
	...
	if(isEmpty()) return '\0';  // Return null byte if queue is empty
	else
	{
		head++;
		id = theQueue[head % MAX_SIZE];		// Get id to return
		return id;				// Return popped id value
	}
}
